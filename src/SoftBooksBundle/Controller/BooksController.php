...
use SoftBooksBundle\Entity\Books;
use SoftBooksBundle\Form\BooksType;
...
class BooksController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SoftBooksBundle:Books')->findAll();

        return $this->render('SoftBooksBundle:Books:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SoftBooksBundle:Books:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SoftBooksBundle:Books')->find($id);
        ...
        return $this->render('SoftBooksBundle:Books:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SoftBooksBundle:Books:edit.html.twig', array(
            'entity'      => $entity,
